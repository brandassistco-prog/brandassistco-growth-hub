    ...
    <footer className="relative mt-24 border-t border-white/5 bg-surface/40">
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 md:grid-cols-12">
        <div className="md:col-span-5">
          ...
          <p className="mt-4 max-w-sm text-sm text-muted-foreground">
            BrandAssistCo helps small businesses build, grow and connect online with
            websites, social media, content, customer support and growth strategies.
            Founded by Bharat Mali in Mumbai, India.
          </p>
        ...
        <div className="md:col-span-3">
          ...
          >
            <Mail className="h-4 w-4" /> brandassistco@gmail.com
          </a>
          <a
            href="https://instagram.com/brandassistco"
            target="_blank"
          ...
          >
            <Instagram className="h-4 w-4" /> @brandassistco
          </a>
      ...
      <div className="border-t border-white/5">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-6 text-xs text-muted-foreground md:flex-row">
          <p>© {new Date().getFullYear()} BrandAssistCo · Founded by Bharat Mali</p>
          <p>Build · Grow · Connect</p>
        </div>
      </div>
    </footer>
  );
